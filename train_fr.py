...
if __name__ == "__main__":
    ...
    train_data = datasets.load_from_disk('s3://mtacl/tokenized_data_fr/train_ver', fs=s3)
    print("loading test data")
    test_data = datasets.load_from_disk('s3://mtacl/tokenized_data_fr/test_ver', fs=s3)
    print("loading validation data")
    val_data = datasets.load_from_disk('s3://mtacl/tokenized_data_fr/validation_ver', fs=s3)
